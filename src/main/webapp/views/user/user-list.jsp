                    ...
                    <div class="page-container">
                        ...
                        <div class="d-flex justify-content-between align-items-end mb-4">
                            <div>
                                ...
                                <p class="body-md text-on-surface-variant mb-0">Danh sách nhân viên (${totalRecords}
                                    người)</p>
                            </div>
                        ...
                        <div class="card-premium overflow-hidden d-flex flex-column mb-4 w-100">
                                ...
                                <form action="${pageContext.request.contextPath}/user-list" method="GET"
                                    ...
                                    <div class="col-md-3 position-relative">
                                        ...
                                        <input type="text" name="keyword" value="${keyword}"
                                            class="input-premium w-100 py-1" placeholder="Tìm mã NV, tên..."
                                    ...
                                    <div class="col-md-2">
                                        <select name="isActive" class="form-select input-premium">
                                            ...
                                            <option value="1" ${selectedStatus=='1' ? 'selected' : '' }>Đang làm
                                            </option>
                                            ...
                                            <c:when test="${empty users}">
                                                <tr>
                                                    <td colspan="8" class="text-center py-4 text-on-surface-variant">
                                                        Không tìm thấy nhân viên nào.</td>
                                                </tr>
                                            </c:when>
                                            <c:otherwise>
                                                <c:forEach var="u" items="${users}">
                                                    <tr <c:if test="${!u.isActive}">style="background-color:
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge border bg-surface-container-high text-on-surface">
                                                                ${u.employeeType}
                                                            </span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="d-flex justify-content-end gap-1">
                                                                <a href="${pageContext.request.contextPath}/user-detail?id=${u.id}"
                                                                    class="btn btn-sm btn-icon text-on-surface-variant hover-primary"
                                                                    title="Xem chi tiết">
                                                                    <span class="material-symbols-outlined"
                                                                        style="font-size: 1.25rem;">visibility</span>
                                                                </a>
                                                                <a href="${pageContext.request.contextPath}/user-update?id=${u.id}"
                                                                    class="btn btn-sm btn-icon text-on-surface-variant hover-primary"
                                                                    title="Chỉnh sửa">
                                                                    <span class="material-symbols-outlined"
                                                                ...
                                                                <form method="post"
                                                                    action="${pageContext.request.contextPath}/user-status"
                                                                    class="d-inline m-0">
                                                                    ...
                                                                    <button type="submit"
                                                                        ...
                                                                        onclick="return confirm('${u.isActive ? 'Khóa' : 'Mở'} tài khoản ${u.fullName}?')">
                                                                        <span class="material-symbols-outlined"
                                                                            style="font-size: 1.25rem;">${u.isActive ?
                                                                            'lock' : 'lock_open'}</span>
                                                                    </button>
                                                                </form>
                                                            </div>
                            ...
                            <c:if test="${totalPages > 1}">
                                <div
                                    class="p-3 bg-surface border-top border-outline-variant d-flex align-items-center justify-content-between">
                                    <span class="body-sm text-on-surface-variant">Trang ${currentPage} /
                                        ${totalPages}</span>
