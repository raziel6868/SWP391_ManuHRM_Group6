        ...
        <div class="main-content">
            ...
            <div class="page-container d-flex flex-column" style="max-width: 700px; margin: 40px auto; width: 100%;">
                <div class="mb-4">
                    ...
                    <p class="body-md text-on-surface-variant mb-0">Thay đổi thông tin chi tiết của vai trò trên hệ thống.</p>
                </div>
                ...
                <div class="card-premium p-4 p-md-5">
                    <form action="${pageContext.request.contextPath}/role-update" method="POST">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-12">
                                <label class="form-label text-on-surface fw-medium mb-1">Mã hệ thống (Không cho phép sửa)</label>
                                <input type="text" class="form-control input-premium" 
                                       value="${role.name}" disabled style="background-color: var(--surface-container-high);" />
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control input-premium" rows="4">${role.description}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-3 pt-3 border-top border-outline-variant">
                            ...
                            <a href="${pageContext.request.contextPath}/role-list" class="btn btn-light border px-4 py-2 d-flex align-items-center gap-2">
                                Hủy bỏ
                            </a>
                        </div>
                    </form>
