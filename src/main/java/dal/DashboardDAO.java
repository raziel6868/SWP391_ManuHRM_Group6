	...
	public DashboardStats getDashboardStats() {
		String sql = """
				SELECT
				    ...
				    SUM(CASE WHEN u.is_active = TRUE AND u.employee_type = 'OFFICE' THEN 1 ELSE 0 END)
				        AS office_users,
				    SUM(CASE WHEN u.is_active = TRUE AND u.employee_type = 'WORKER' THEN 1 ELSE 0 END)
				        AS worker_users,
