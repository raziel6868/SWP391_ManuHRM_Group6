...
<head>
    ...
    <title>Thêm Ngày lễ - ManuHRM</title>
        ...
        <div class="main-content">
            ...
            <div class="page-container">
                ...
                <div class="d-flex align-items-center gap-3 mb-4">
                    ...
                    <div>
                        <h2 class="h3 text-on-surface fw-bold mb-1">Thêm Ngày lễ</h2>
                        <p class="body-md text-on-surface-variant mb-0">Nhập thông tin ngày lễ mới.</p>
                    </div>
                </div>

                <div class="card-premium p-4" style="max-width: 600px;">
                    <form action="${pageContext.request.contextPath}/holiday-create" method="POST">
                        <div class="mb-3">
                            <label for="date" class="form-label text-on-surface fw-medium">
                                Ngày <span class="text-danger">*</span>
                            </label>
                            <input type="date" id="date" name="date" class="input-premium w-100" required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" class="input-premium w-100"
