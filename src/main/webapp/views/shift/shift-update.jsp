...
<head>
    ...
    <title>Cập nhật ca làm việc - ManuHRM</title>
    ...
    <div class="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-container d-flex flex-column" style="max-width: 720px; margin: 40px auto; width: 100%;">
                <div class="mb-4">
                    <h2 class="h3 text-on-surface fw-bold mb-1">Cập nhật ca làm việc</h2>
                    <p class="body-md text-on-surface-variant mb-0">Chỉnh sửa thông tin ca làm việc trong hệ thống.</p>
                </div>
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="code" class="form-control input-premium"
                                       value="${shift.code}" required maxlength="30" pattern="^[A-Z][A-Z0-9_]*$" />
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control input-premium"
                                       value="${shift.name}" required maxlength="100" />
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="breakMinutes" class="form-control input-premium"
                                       value="${shift.breakMinutes}" min="0" max="480" />
                                <div class="form-text mt-1 text-on-surface-variant">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="isNightShift" class="form-select input-premium">
                                    <option value="false" ${!shift.isNightShift ? 'selected' : ''}>Ca ngày</option>
                                    <option value="true" ${shift.isNightShift ? 'selected' : ''}>Ca đêm</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control input-premium"
                                       value="${shift.isActive ? 'Hoạt động' : 'Vô hiệu hóa'}"
