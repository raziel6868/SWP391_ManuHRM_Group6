    ...
    <div class="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-container d-flex flex-column"
                ...
                <div class="mb-4">
                    <%-- FIX: Không nên ngắt dòng trong chuỗi EL --%>
                ...
                <div class="card-premium p-4 p-md-5">
                    <form action="${pageContext.request.contextPath}/${not empty user.id ? 'user-update' : 'user-create'}"
                        method="POST">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                ...
                                <%-- FIX: Dùng <c:if> thay cho EL ternary để xuất attribute readonly + style --%>
                                <input type="text" name="employeeCode" class="form-control input-premium"
                                    ...
                                    <c:if test="${not empty user.id}">readonly style="background-color: var(--surface-container-high);"</c:if> />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label text-on-surface fw-medium mb-1">Tên đăng nhập <span class="text-danger">*</span></label>
                                <%-- FIX: Tương tự employeeCode --%>
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-on-surface fw-medium mb-1">Mật khẩu
                                ...
                                <input type="password" name="password" class="form-control input-premium"
                                    ${not empty user.id ? '' : 'required'} minlength="6" />
                                <c:if test="${not empty user.id}">
                            ...
                            <div class="col-md-6 d-flex align-items-center mt-4">
                                <div class="form-check form-switch mt-3">
                                    <%-- FIX: 'checked' phải có dấu nháy, nhánh false phải là '' --%>
