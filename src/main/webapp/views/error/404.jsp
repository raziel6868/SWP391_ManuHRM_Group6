...
<head>
    ...
    <title>404 Not Found - ManuHRM</title>
        <!-- Bootstrap 5 CSS -->
...
<body class="d-flex align-items-center justify-content-center min-vh-100 bg-background text-on-background">
    <main class="w-100 text-center d-flex flex-column align-items-center" style="max-width: 600px; padding: 2rem;">
        ...
        <div class="mb-3 d-flex flex-column align-items-center">
            <span class="label-md text-outline mb-2" style="letter-spacing: 0.2em;">SYSTEM ERROR : 404</span>
            <h1 class="display-4 fw-bolder text-on-background mb-0">Resource Not Found</h1>
        </div>
        ...
        <p class="body-lg text-on-surface-variant mb-5" style="max-width: 450px;">
            The page you are looking for might have been removed, had its name changed, or is temporarily unavailable within the system directory.
        </p>
