...
//
// private final ShiftAssignmentDAO shiftAssignmentDAO = new
// ShiftAssignmentDAO();
...
//
// if (userIdParam != null && !userIdParam.isBlank() && startDateParam != null
// && !startDateParam.isBlank()
...
// shiftAssignmentDAO.getByUserIdAndDateRange(userId,
...
// }
//
// request.getRequestDispatcher("/views/shiftconflict/shift-conflict.jsp").forward(request,
// response);
// }
//
// @Override
...
// session.setAttribute("errorMsg", "Dinh dang ngay khong hop le. Su dung
// YYYY-MM-DD.");
// response.sendRedirect(request.getContextPath() + "/shift-conflict");
// return;
// }
...
// session.setAttribute("errorMsg", "Ngay ket thuc phai lon hon hoac bang ngay
// bat dau.");
// response.sendRedirect(request.getContextPath() + "/shift-conflict");
// return;
// }
...
//
// if (hasConflict) {
// session.setAttribute("warningMsg", "Xung dot phat hien: Nhan vien da co lich
// lam viec vao ngay "
// + conflictAssignment.getDate() + " voi ca " +
// conflictAssignment.getShiftName());
// } else if (!existingAssignments.isEmpty()) {
// session.setAttribute("successMsg", "Khong co xung dot. Nhan vien co " +
// existingAssignments.size()
// + " ca lam viec trong khoang thoi gian nay.");
// } else {
// session.setAttribute("successMsg",
// "Khong co xung dot. Nhan vien chua co ca lam viec trong khoang thoi gian
// nay.");
// }
//
// response.sendRedirect(request.getContextPath() + "/shift-conflict");
