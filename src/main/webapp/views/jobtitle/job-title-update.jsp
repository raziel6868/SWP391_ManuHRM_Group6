...
<head>
    ...
    <title>Cập nhật Chức danh - ManuHRM</title>
    ...
    <div class="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-container d-flex flex-column" style="max-width: 600px; margin: 40px auto; width: 100%;">
                <div class="mb-4">
                    <h2 class="h3 text-on-surface fw-bold mb-1">Cập nhật Chức danh</h2>
                    <p class="body-md text-on-surface-variant mb-0">Chỉnh sửa thông tin chức danh trong hệ thống.</p>
                </div>
                ...
                <div class="card-premium p-4 p-md-5">
                    <form action="${pageContext.request.contextPath}/job-title-update" method="POST">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control input-premium"
                                    value="${jobTitle.name}" required maxlength="100"
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control input-premium"
                                    ...
                                    placeholder="Mô tả chức danh này...">${jobTitle.description}</textarea>
