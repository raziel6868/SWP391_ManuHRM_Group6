            ...
            <div class="page-container">
                ...
                <div class="d-flex justify-content-between align-items-end mb-4">
                    <div>
                        ...
                        <p class="body-md text-on-surface-variant mb-0">Manage system access levels and functional permissions.</p>
                    </div>
                    <a href="${pageContext.request.contextPath}/role-update" class="btn-primary-gradient text-decoration-none px-3 py-2 d-flex align-items-center gap-2 shadow-sm">
                ...
                <div class="card-premium overflow-hidden d-flex flex-column mb-4 w-100">
                    ...
                    <div class="p-3 bg-surface border-bottom border-outline-variant d-flex justify-content-between align-items-center">
                        <form action="${pageContext.request.contextPath}/role-list" method="GET" class="d-flex position-relative" style="width: 280px;">
                            ...
                            <input type="text" name="keyword" value="${keyword}" class="input-premium w-100 py-1" placeholder="Filter roles..." style="padding-left: 2.5rem;"/>
                        ...
                        <table class="table table-premium mb-0 w-100">
                            ...
                            <tbody>
                                    ...
                                    <tr <c:if test="${!r.isActive}">style="background-color: rgba(255,255,255,0.5); opacity: 0.8;"</c:if>>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${r.isSystem}">
                                                    <span class="badge border d-inline-flex align-items-center text-on-surface fw-medium" style="background-color: var(--surface-container-high); border-color: var(--outline-variant) !important;">
                                                        <span class="material-symbols-outlined me-1" style="font-size: 0.875rem;">shield</span> System
                                                    </span>
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex justify-content-end gap-1">
                                                <a href="${pageContext.request.contextPath}/role-update?id=${r.id}" class="btn btn-sm btn-icon text-on-surface-variant hover-primary" title="Edit">
                                                    <span class="material-symbols-outlined" style="font-size: 1.25rem;">edit</span>
                                                </a>
                                                <a href="${pageContext.request.contextPath}/role-permission?id=${r.id}" class="btn btn-sm btn-icon text-on-surface-variant hover-primary" title="Permissions">
                                                ...
                                                <c:if test="${!r.isSystem}">
                                                    <form action="${pageContext.request.contextPath}/role-status" method="POST" class="d-inline m-0">
                                                        ...
                                                        <button type="submit" class="btn btn-sm btn-icon text-on-surface-variant hover-primary" title="${r.isActive ? 'Deactivate' : 'Activate'}">
                                ...
                                <c:if test="${empty roles}">
                                    <tr>
                                        <td colspan="6" class="text-center py-4 text-on-surface-variant">No roles found.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
